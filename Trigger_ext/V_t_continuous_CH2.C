...
void V_t_continuous_CH2()
{
	...
	while(1)
	{
		...
		sprintf(Command,"./fald-simple-acq-CH2 -a 10 -b 10 -n 1 -t 10000 -c 1 0x100 > /tmp/fmcadc.0x0100.ch1.dat.INT");
		...
		*/
		...
		gr->Draw("ACP");
		//persistent mode
		//if(first == 0) {gr->Draw("ACP"); first =1;}
		//else{gr->Draw("CP");}
